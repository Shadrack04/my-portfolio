...
export default function StackItem() {
  return (
    <div className=" card-shadow border-primary-color border-1  bg-[#ECFAE5] w-[16rem] hover:scale-105 transition-all duration-300 flex items-center flex-col py-6 px-4 rounded-2xl">
