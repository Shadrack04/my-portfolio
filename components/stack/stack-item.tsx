...
export default function StackItem() {
  return (
    <div className=" card-shadow hover:border-1 hover:border-primary-color bg-background w-[20rem] hover:scale-105 transition-all duration-300 flex items-center flex-col py-6 px-4 rounded-2xl">
