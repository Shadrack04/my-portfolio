...
export default function Navbar() {
  return (
    <nav className=" flex items-center justify-center z-90">
      <ul className="nav-shadow flex border-1 bg-foreground border-primary-button z-99 items-center text-[90%] justify-center fixed top-4 gap-2 md:gap-6 px-4 py-3 rounded-full">
