...
export default function Navbar() {
  return (
    <nav className=" flex items-center justify-center z-99">
      <ul className="nav-shadow flex border-1 bg-foreground/50 border-primary-button items-center text-[90%] justify-center fixed bottom-8 gap-6 px-4 py-3 rounded-full">
